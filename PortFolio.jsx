...
import { Mail, Linkedin, Github, ExternalLink, GraduationCap, MapPin, Building, X, Send, Bot, User } from 'lucide-react';
        ...
        <div className="flex flex-col md:flex-row gap-4 w-full max-w-4xl justify-center items-stretch z-10">
          ...
          >
            <div className="p-3 bg-white/5 rounded-xl group-hover:bg-violet-500/10 transition-colors">
              <Github className="w-5 h-5 text-gray-400 group-hover:text-violet-400 transition-colors" />
            </div>
            <div className="flex flex-col items-start flex-1 overflow-hidden">
